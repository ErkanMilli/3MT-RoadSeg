...
class KITTIRoad(data.Dataset):
    ...
    def __init__(self,
        ...
        if split == 'train':
            ...
            self.depth_gt_base = os.path.join(self.root, 'training', 'proj_depth/groundtruth/image_2_split')
            ...
            self.annotations_base = os.path.join(self.root, 'testing', 'gt_image_2_split')
            self.depth_gt_base = os.path.join(self.root, 'testing', 'proj_depth/groundtruth/image_2_split')
            self.split = 'test'
            ...
            # self.lbl_files = recursive_glob(rootdir=self.annotations_base, suffix='.png')
            # self.lbl_files = sorted(self.lbl_files)
    ...
    def __getitem__(self, index):
        ...
        # lbl_path_ = self.lbl_files[index].rstrip()
        # lbl_name_splits = lbl_path_.split(os.sep)[-1].split('.')[0].split('_')
