...
## Datasets
You can download the KITTI dataset from [KITTI](https://www.cvlibs.net/datasets/kitti/) and the Cityscapes dataset from B, both used in the 3MT-RoadSeg study. Depth images can be obtained from the C repository. You can access the 3-channel ADIs from here
